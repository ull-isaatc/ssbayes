%Función que transforma la medida como si tuvieramos un telémetro láser
...
%Función para limitar la distancia de medida como si fuera real
...
%   distancia que hemos medido. Además dependendiendo de la función de
%   medida utilizada podremos determinar cuales son las balizas que han
%   generado dichas medidas. El hecho de utilizar las medidas de rotación nos sirve para 
% 	representar el ángulo en el que se realiza la medida.
